...
const ExperienceSection = () => {
  ...
  return (
    <section 
      id="experience" 
      ref={ref}
      className={`section-padding ${theme === 'dark' ? 'bg-[var(--about-bg)]' : 'bg-[var(--about-bg)]'} transition-colors duration-300`}
    >
      <div className="container-width">
        <h2 className={`text-4xl md:text-5xl font-bold ${
          theme === 'dark' ? 'text-white' : 'text-gray-900'
        } mb-12 pl-8 md:pl-16 transform transition-all duration-700 ${
        ...
        <div className="relative">
          <div className="absolute left-1/2 top-8 bottom-0 h-[calc(100%-3rem)] w-0.5 bg-gradient-to-b from-blue-500 to-purple-500 transform -translate-x-1/2" />
